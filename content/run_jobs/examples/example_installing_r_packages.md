---
source: https://docs.rcac.purdue.edu/userguides/gilbreth/run_jobs/examples/example_installing_r_packages/
section: run_jobs
slug: run_jobs/examples/example_installing_r_packages
...
- For your convenience, a sample ~/.Rprofile example file is provided that can be downloaded to your cluster account and renamed into `~/.Rprofile` (or appended to one) to customize your installation preferences. Detailed instructions here.
