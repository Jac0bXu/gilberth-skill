---
source: https://docs.rcac.purdue.edu/userguides/gilbreth/run_jobs/ansysfluent_example/
section: run_jobs
slug: run_jobs/ansysfluent_example
title: Ansys Fluent - RCAC Documentation
---
...
The Ansys licensing on our community clusters is maintained by Purdue ECN group. There are two types of licenses: teaching and research. For more information, please refer to ECN Ansys licensing page. If you are interested in purchasing your own research license, please send email to __software@ecn.purdue.edu__.
...
- __Preparing Case Files for Fluent__
- __Case Calculating with Fluent__
- __Fluent Text User Interface and Journal File__
- __Submitting Fluent jobs to SLURM__
