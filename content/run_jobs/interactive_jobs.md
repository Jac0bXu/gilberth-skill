---
source: https://docs.rcac.purdue.edu/userguides/gilbreth/run_jobs/interactive_jobs/
section: run_jobs
slug: run_jobs/interactive_jobs
...
|  |  |
| --- | --- |
| ``` 1 ``` | ``` sinteractive -A cpu -N2 -n32 --gpus-per-node=1 ``` |
