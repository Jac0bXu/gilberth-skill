---
source: https://docs.rcac.purdue.edu/userguides/gilbreth/run_jobs/matlab/implicit_parallelism/
section: run_jobs
slug: run_jobs/matlab/implicit_parallelism
title: Implicit Parallelism
---

# Implicit Parallelism

MATLAB implements _implicit parallelism_ which is automatic multithreading of many computations, such as matrix multiplication, linear algebra, and performing the same operation on a set of numbers. This is different from the explicit parallelism of the Parallel Computing Toolbox.
