---
source: https://docs.rcac.purdue.edu/userguides/gilbreth/run_jobs/creating_the_submission_script/
section: run_jobs
slug: run_jobs/creating_the_submission_script
title: Job Submission Script
---

# Job Submission Script

To submit work to a SLURM queue, you must first create a _job submission file_. This job submission file is essentially a simple shell script. It will set any required environment variables, load any necessary modules, create or modify files and directories, and run any applications that you need:
