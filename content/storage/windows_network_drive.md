---
source: https://docs.rcac.purdue.edu/userguides/gilbreth/storage/windows_network_drive/
section: storage
slug: storage/windows_network_drive
title: Windows network drive
---
...
> **Note**
>
> To access Gilbreth through SMB file sharing, you must be on a Purdue campus network or connected through VPN.
...
- **Windows 11**: Tap the Windows key, type `File Explorer`, select This PC, click Computer > Map Network Drive in the top bar
  ...
  - To access your scratch space on Gilbreth, enter `\\scratch.gilbreth.rcac.purdue.edu\gilbreth-scratch`
...
> - Servername: `\\home.gilbreth.rcac.purdue.edu` or `\\scratch.gilbreth.rcac.purdue.edu`
...
- To access your scratch space on Gilbreth, enter `smb://scratch.gilbreth.rcac.purdue.edu/gilbreth-scratch`
...
```
smbclient //home.gilbreth.rcac.purdue.edu/gilbreth-home -U boilerad\myusername
```

```
smbclient //scratch.gilbreth.rcac.purdue.edu/gilbreth-scratch -U boilerad/myusername
```
