---
source: https://docs.rcac.purdue.edu/userguides/gilbreth/compile/compile_intel_mkl/
section: compile
slug: compile/compile_intel_mkl
...
|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 ``` | ``` $ module load intel $ echo $LINK_LAPACK -L${MKL_HOME}/lib/intel64 -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -liomp5 -lpthread  $ echo $LINK_LAPACK95 -L${MKL_HOME}/lib/intel64 -lmkl_lapack95_lp64 -lmkl_blas95_lp64 -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -liomp5 -lpthread ``` |
