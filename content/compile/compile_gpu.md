---
source: https://docs.rcac.purdue.edu/userguides/gilbreth/compile/compile_gpu/
section: compile
slug: compile/compile_gpu
title: Compiling GPU Programs
---

# Compiling GPU Programs

The Gilbreth cluster nodes contain GPUs that support _CUDA_ and _OpenCL_. See the Gilbreth Overview for the specifics on the GPUs in Gilbreth. This section focuses on using CUDA.
...
./gpu_hello
No GPU specified, using first GPU
hello, world
```
...
- NVIDIA The CUDA Compiler Driver NVCC
